    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-14">
        ...
        <div class="relative flex items-center justify-center self-start">
            ...
            <div class="md:hidden flex flex-col gap-4 w-full items-center mt-6">
                <img src="{{ asset('images/faq/faq-1.jpeg') }}" data-aos="fade-down-right" class="w-48 h-56 rounded shadow-lg object-cover">
                <img src="{{ asset('images/faq/faq-2.jpeg') }}" data-aos="fade-left" class="w-48 h-56 rounded shadow-lg object-cover">
                <img src="{{ asset('images/faq/faq-3.jpeg') }}" data-aos="fade-up-left" class="w-56 h-64 rounded shadow-lg object-cover">
            </div>
